...
# Index
- [Primary](/linux/debianConfig/serviceConfigurations/dhcp/basicPrimary.md)
- [Secondary](/linux/debianConfig/serviceConfigurations/dhcp/basicSecondary.md)

# File index
- [/etc/default/isc-dhcp-server](/linux/debianConfig/configurationFiles/etc/default/isc-dhcp-server.md) – Specifies interfaces to serve
